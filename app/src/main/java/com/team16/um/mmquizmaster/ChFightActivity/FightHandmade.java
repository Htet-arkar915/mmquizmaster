...
public class FightHandmade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation= AnimationUtils.loadAnimation(FightHandmade.this,R.anim.bounce_left);
        rv1.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightHandmade.this,R.anim.bounce_right);
        rv2.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightHandmade.this,R.anim.bounce_down);
        rv3.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightHandmade.this,R.anim.bounce_up);
        rv4.startAnimation(animation);
        animation=AnimationUtils.loadAnimation(FightHandmade.this,R.anim.fade_out);
        ...
        Firebase.setAndroidContext(FightHandmade.this);
        final SharedPreferences sp = FightHandmade.this.getSharedPreferences("userdata", MODE_PRIVATE);
        Glide.with(FightHandmade.this).load(sp.getString("profile","")).into(chimg);
        Glide.with(FightHandmade.this).load(parm.getUserImgurl()).into(acceptimg);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* inputfirebase.child("Challenge").child(sp.getString("userid","")+parm.getUserId())
                ...
                Intent intent=new Intent(FightHandmade.this,Fighting.class);
    ...
    private String LoadJSONFromAsset() {
        ...
        try{
            InputStream inputstream=getAssets().open("culture.json");
    ...
    private void produceData(DataSnapshot dataSnapshot) {
        for (DataSnapshot dsh:dataSnapshot.getChildren()){
            // Toast.makeText(FightHandmade.this,dsh.getValue(UserfirebaseInfo.class).getUserId(),Toast.LENGTH_LONG).show();
