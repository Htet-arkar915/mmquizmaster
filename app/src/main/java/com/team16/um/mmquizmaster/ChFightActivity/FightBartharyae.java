...
public class FightBartharyae extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation= AnimationUtils.loadAnimation(FightBartharyae.this,R.anim.bounce_left);
        rv1.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightBartharyae.this,R.anim.bounce_right);
        rv2.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightBartharyae.this,R.anim.bounce_down);
        rv3.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightBartharyae.this,R.anim.bounce_up);
        rv4.startAnimation(animation);
        animation=AnimationUtils.loadAnimation(FightBartharyae.this,R.anim.fade_out);
        ...
        Firebase.setAndroidContext(FightBartharyae.this);
        final SharedPreferences sp = FightBartharyae.this.getSharedPreferences("userdata", MODE_PRIVATE);
        Glide.with(FightBartharyae.this).load(sp.getString("profile","")).into(chimg);
        Glide.with(FightBartharyae.this).load(parm.getUserImgurl()).into(acceptimg);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* inputfirebase.child("Challenge").child(sp.getString("userid","")+parm.getUserId())
                ...
                Intent intent=new Intent(FightBartharyae.this,Fighting.class);
    ...
    private String LoadJSONFromAsset() {
        ...
        try{
            InputStream inputstream=getAssets().open("buddha.json");
    ...
    private void produceData(DataSnapshot dataSnapshot) {
        for (DataSnapshot dsh:dataSnapshot.getChildren()){
            // Toast.makeText(FightBartharyae.this,dsh.getValue(UserfirebaseInfo.class).getUserId(),Toast.LENGTH_LONG).show();
