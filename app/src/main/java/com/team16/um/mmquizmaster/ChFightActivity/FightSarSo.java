...
public class FightSarSo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation= AnimationUtils.loadAnimation(FightSarSo.this,R.anim.bounce_left);
        rv1.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightSarSo.this,R.anim.bounce_right);
        rv2.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightSarSo.this,R.anim.bounce_down);
        rv3.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightSarSo.this,R.anim.bounce_up);
        rv4.startAnimation(animation);
        animation=AnimationUtils.loadAnimation(FightSarSo.this,R.anim.fade_out);
        ...
        Firebase.setAndroidContext(FightSarSo.this);
        final SharedPreferences sp = FightSarSo.this.getSharedPreferences("userdata", MODE_PRIVATE);
        Glide.with(FightSarSo.this).load(sp.getString("profile","")).into(chimg);
        Glide.with(FightSarSo.this).load(parm.getUserImgurl()).into(acceptimg);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* inputfirebase.child("Challenge").child(sp.getString("userid","")+parm.getUserId())
                ...
                Intent intent=new Intent(FightSarSo.this,Fighting.class);
    ...
    private void produceData(DataSnapshot dataSnapshot) {
        for (DataSnapshot dsh:dataSnapshot.getChildren()){
            // Toast.makeText(FightSarSo.this,dsh.getValue(UserfirebaseInfo.class).getUserId(),Toast.LENGTH_LONG).show();
