...
public class FightAhtwehtwe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation= AnimationUtils.loadAnimation(FightAhtwehtwe.this,R.anim.bounce_left);
        rv1.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightAhtwehtwe.this,R.anim.bounce_right);
        rv2.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightAhtwehtwe.this,R.anim.bounce_down);
        rv3.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightAhtwehtwe.this,R.anim.bounce_up);
        rv4.startAnimation(animation);
        animation=AnimationUtils.loadAnimation(FightAhtwehtwe.this,R.anim.fade_out);
        ...
        Firebase.setAndroidContext(FightAhtwehtwe.this);
        final SharedPreferences sp = FightAhtwehtwe.this.getSharedPreferences("userdata", MODE_PRIVATE);
        Glide.with(FightAhtwehtwe.this).load(sp.getString("profile","")).into(chimg);
        Glide.with(FightAhtwehtwe.this).load(parm.getUserImgurl()).into(acceptimg);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* inputfirebase.child("Challenge").child(sp.getString("userid","")+parm.getUserId())
                ...
                startActivity(new Intent(FightAhtwehtwe.this,Fighting.class)
    ...
    private void produceData(DataSnapshot dataSnapshot) {
        for (DataSnapshot dsh:dataSnapshot.getChildren()){
            // Toast.makeText(FightAhtwehtwe.this,dsh.getValue(UserfirebaseInfo.class).getUserId(),Toast.LENGTH_LONG).show();
