...
public class FightRiver_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation= AnimationUtils.loadAnimation(FightRiver_activity.this,R.anim.bounce_left);
        rv1.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightRiver_activity.this,R.anim.bounce_right);
        rv2.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightRiver_activity.this,R.anim.bounce_down);
        rv3.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightRiver_activity.this,R.anim.bounce_up);
        rv4.startAnimation(animation);
        animation=AnimationUtils.loadAnimation(FightRiver_activity.this,R.anim.fade_out);
        ...
        Firebase.setAndroidContext(FightRiver_activity.this);
        final SharedPreferences sp = FightRiver_activity.this.getSharedPreferences("userdata", MODE_PRIVATE);
        Glide.with(FightRiver_activity.this).load(sp.getString("profile","")).into(chimg);
        Glide.with(FightRiver_activity.this).load(parm.getUserImgurl()).into(acceptimg);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* inputfirebase.child("Challenge").child(sp.getString("userid","")+parm.getUserId())
                ...
                Intent intent=new Intent(FightRiver_activity.this,Fighting.class);
    ...
    private String LoadJSONFromAsset() {
        ...
        try{
            InputStream inputstream=getAssets().open("newriver.json");
    ...
    private void produceData(DataSnapshot dataSnapshot) {
        for (DataSnapshot dsh:dataSnapshot.getChildren()){
            // Toast.makeText(FightRiver_activity.this,dsh.getValue(UserfirebaseInfo.class).getUserId(),Toast.LENGTH_LONG).show();
