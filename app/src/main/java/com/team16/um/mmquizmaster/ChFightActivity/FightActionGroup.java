...
import com.team16.um.mmquizmaster.Model.Challengetime;
...
import static com.team16.um.mmquizmaster.R.id.relative3;

public class FightActionGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation= AnimationUtils.loadAnimation(FightActionGroup.this,R.anim.bounce_left);
        rv1.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightActionGroup.this,R.anim.bounce_right);
        rv2.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightActionGroup.this,R.anim.bounce_down);
        rv3.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightActionGroup.this,R.anim.bounce_up);
        rv4.startAnimation(animation);
        animation=AnimationUtils.loadAnimation(FightActionGroup.this,R.anim.fade_out);
        ...
        Firebase.setAndroidContext(FightActionGroup.this);
        final SharedPreferences sp = FightActionGroup.this.getSharedPreferences("userdata", MODE_PRIVATE);
        Glide.with(FightActionGroup.this).load(sp.getString("profile","")).into(chimg);
        Glide.with(FightActionGroup.this).load(parm.getUserImgurl()).into(acceptimg);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* inputfirebase.child("Challenge").child(sp.getString("userid","")+parm.getUserId())
                ...
                startActivity(new Intent(FightActionGroup.this,Fighting.class)
                        .putExtra("userfbinfo", ChallengeRecycler.clickuser));
                finish();
    ...
    private String LoadJSONFromAsset() {
        ...
        try{
            InputStream inputstream=getAssets().open("actiongroup.json");
