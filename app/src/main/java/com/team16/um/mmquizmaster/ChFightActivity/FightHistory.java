...
public class FightHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation= AnimationUtils.loadAnimation(FightHistory.this,R.anim.bounce_left);
        rv1.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightHistory.this,R.anim.bounce_right);
        rv2.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightHistory.this,R.anim.bounce_down);
        rv3.startAnimation(animation);
        animation= AnimationUtils.loadAnimation(FightHistory.this,R.anim.bounce_up);
        rv4.startAnimation(animation);
        animation=AnimationUtils.loadAnimation(FightHistory.this,R.anim.fade_out);
        ...
        Firebase.setAndroidContext(FightHistory.this);
        final SharedPreferences sp = FightHistory.this.getSharedPreferences("userdata", MODE_PRIVATE);
        Glide.with(FightHistory.this).load(sp.getString("profile","")).into(chimg);
        Glide.with(FightHistory.this).load(parm.getUserImgurl()).into(acceptimg);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* inputfirebase.child("Challenge").child(sp.getString("userid","")+parm.getUserId())
                ...
                Intent intent=new Intent(FightHistory.this,Fighting.class);
    ...
    private void produceData(DataSnapshot dataSnapshot) {
        for (DataSnapshot dsh:dataSnapshot.getChildren()){
            // Toast.makeText(FightHistory.this,dsh.getValue(UserfirebaseInfo.class).getUserId(),Toast.LENGTH_LONG).show();
